...
// Constructors
vec3::vec3() : e{0, 0, 0} {}   // initializing default constructor
vec3::vec3(double x, double y, double z) : e{x, y, z} {}   // initializing constructor

// Getters
double vec3::x() const { return e[0]; }   // functions to call elements of vectors (not changeable)
double vec3::y() const { return e[1]; }
double vec3::z() const { return e[2]; }

// Member functions
double vec3::mod() const {
    return sqrt(mod_squared());
}

double vec3::mod_squared() const {
    return x() * x() + y() * y() + z() * z();
}
